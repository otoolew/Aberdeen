...
public class ChargeState : UnitBaseFSM
{
    ...
    {   // WayPoint Check   
        ...
        var lookPos = wayPoints[currentWP].transform.position - unitBrain.transform.position;
        lookPos.y = 0;
        Quaternion rotation = Quaternion.LookRotation(lookPos);
        unitBrain.transform.rotation = rotation;
