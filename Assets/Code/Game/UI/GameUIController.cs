...
public class GameUIController : Singleton<GameUIController>
{
    ...
    ///// whilst placing
    ///// </summary>
    //public UnitInfoUI buildInfoUI;

    ///// <summary>
    ///// Fires when the <see cref="UIState"/> changes
    ...
    ///// <summary>
    ///// Current tower placeholder. Will be null if not in the <see cref="UIState.Building" /> state.
    ///// </summary>
    ...
    //    get
    //    {
    //        return state == UIState.Building || state == UIState.BuildingWithDrag;
    //    }
    //}
    ...
    //    }
    //    SetState(UIState.BuildingWithDrag);
    //}
    ...
    //    if (oldState == UIState.Paused || oldState == UIState.GameOver)
    //    {
    //        Time.timeScale = 1f;
    //    }
    ...
    //            break;
    //        case UIState.BuildingWithDrag:
    //            break;
    //        case UIState.Paused:
    //        case UIState.GameOver:
    //            if (oldState == UIState.Building)
    //            {
    ...
    ///// </param>
    ///// <exception cref="InvalidOperationException">
    ///// Throws exception when selecting tower when <see cref="UIState" /> does not equal <see cref="UIState.Normal" />
    ///// </exception>
    ...
    ///// </returns>
    ///// <exception cref="InvalidOperationException">
    ///// Throws exception if the check is done in <see cref="UIState.Normal"/> state
    ///// </exception>
    ...
    ///// </param>
    ///// <exception cref="InvalidOperationException">
    ///// Throws an exception when not in <see cref="UIState.Normal"/>
    ///// </exception>
